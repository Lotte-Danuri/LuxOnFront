...
main table tbody td {
  height: 2.8rem;
  border-bottom: 1px solide var(--color-light);
  color: var(--color-dark-variant);
}
...
.right .sales-anlytics .add-product {
